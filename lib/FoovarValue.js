  ...
  _createClass(FoovarValue, [{
    ...
    value: function resolveObjectValue(exp) {
      ...
      return Object.keys(exp.vals).reduce(function (o, k) {
        var v = exp.vals[k];
        o[_this2.resolvePropertyKey(k)] = new _this2(new _StylusExpression2.default(v, exp.fromJson));
        return o;
      }, {});
    }
  }, {
    ...
    key: 'resolvePropertyKey',
    value: function resolvePropertyKey(k) {
      if (this.case === 'raw') {
        return k;
      } else {
        return _case2.default[this.case || 'camel'](k);
      }
    }
  }]);
